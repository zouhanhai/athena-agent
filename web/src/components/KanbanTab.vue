...
/** Rescan the local board (rebuild the index). */
function refresh(): void {
  void loadBoard(true);
}

/** Toolbar status line reflects the local scan state. */
...
/** Refresh button label reflects the local scan state. */
const refreshLabel = computed(() => (loading.value ? "Scanning…" : "Refresh"));
      ...
      <div class="kanban-toolbar">
        <div class="kanban-toolbar-left">
          ...
          <span
            ...
            :class="{ 'kanban-refreshed': !loading }"
            aria-live="polite"
          >
            <span v-if="loading" class="kanban-spinner" aria-hidden="true" />
            {{ activeStatus }}
          </span>
        </div>

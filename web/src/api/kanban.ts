/**
 * Frontend API layer for the GitHub Project board view (G4.S5 + G4.S6.T4).
 * The local GST board stack was removed — the GitHub Project panel is the only
 * board view. Scoped to the signed-in employee via their session token.
 */
